...
table.cell(t, 0, 0, "Trend", color.white, _colorNew(color.blue, 70));
table.cell(t, 1, 0, (trend ? "UP" : "DN"), (trend ? color.lime : color.red), _colorNew(color.black, 0));
table.cell(t, 0, 1, "Score", color.white, _colorNew(color.gray, 70));
table.cell(t, 1, 1, String(score), color.yellow, _colorNew(color.black, 0));
