...
indicator("Momentum & ROC", false);
var length = input.int(10, "Length");
Std.plot(StdPlus.mom(context, _series_close, length), "Momentum", color.blue);
Std.plot(Std.roc(_series_close, length, context), "ROC", color.orange);