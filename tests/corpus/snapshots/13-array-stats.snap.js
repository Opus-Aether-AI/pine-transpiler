...
Std.plot((_arraySum(arr) / _arraySize(arr)), "Avg", color.blue);
Std.plot(_arrayMax(arr), "Max", color.green);
Std.plot(_arrayMin(arr), "Min", color.red);