...
var l = _pineVar("l", () => (line.new(bar_index, high, (bar_index + 1), low, color.orange, 2)));
line.set_x2(l, (bar_index + 2));
line.set_xy1(l, bar_index, high);
line.set_xy2(l, (bar_index + 2), low);
line.set_color(l, color.purple);
var b = _pineVar("b", () => (box.new(bar_index, high, (bar_index + 1), low, _colorNew(color.blue, 85), color.yellow, 1)));
box.set_bgcolor(b, _colorNew(color.fuchsia, 70));
box.set_border_color(b, color.black);
box.set_border_width(b, 2);
var lb = _pineVar("lb", () => (label.new(bar_index, high, "L", color.black, color.white, label.style_label_down)));
...
table.cell(t, 0, 0, "A", color.white, _colorNew(color.black, 0));
table.cell(t, 1, 0, "B", color.yellow, _colorNew(color.red, 80));
