...
| Indicator | Fixture | Status | Stage | Error | Lane | Authenticity |
|---|---|---|---|---|---|---|
| Forex Asia Range Box Lite | forex_xau/asia_range_box_lite.pine | PASS | complete |  | synthetic_custom | synthetic |
...
| RSI ROC Momentum Scalper | forex_xau/rsi_roc_momentum_scalper.pine | PASS | complete |  | synthetic_custom | synthetic |
| Session Volume Pressure | forex_xau/session_volume_pressure.pine | PASS | complete |  | synthetic_custom | synthetic |
| VWAP Reversion XAU | forex_xau/vwap_reversion_xau.pine | PASS | complete |  | synthetic_custom | synthetic |
| XAUUSD ATR Regime Filter | forex_xau/xauusd_atr_regime_filter.pine | PASS | complete |  | synthetic_custom | synthetic |
| XAUUSD FVG Lite | forex_xau/xauusd_fvg_lite.pine | PASS | complete |  | synthetic_custom | synthetic |
