...
export interface PineJSStdLibrary {
    ...
    macd: (series: any, fast: number, slow: number, signal: number, context: RuntimeContext) =>
        [number, number, number];
    stoch: (source: any, high: any, low: any, length: number, context: RuntimeContext) => number;
    ...
    bb: (series: any, length: number, mult: number, context: RuntimeContext) =>
        [number, number, number];
    kc: (series: any, length: number, mult: number, context: RuntimeContext) =>
        [number, number, number];
    ...
    valuewhen: (condition: boolean, source: any, occurrence: number, context: RuntimeContext) => number;
...
export interface StudyPlotInfo {
    ...
    /** Plot type/style */
    type: 'line' | 'histogram' | 'circles' | 'column' | 'area' | 'stepline' | 'cross' | 'shape' | 'hline';
}
