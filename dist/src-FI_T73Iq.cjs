...
function generateStandaloneFactory(options) {
	const { indicatorId, indicatorName, name, shortName, overlay, plots, inputs, bgcolors, sessionVariables, derivedSessionVariables, booleanInputMap, computedVariables, inputVariableMap, programAst, historicalAccess } = options;
	...
	const mainBodyCode = generateNativeMainBody(inputs, plots, bgcolors, sessionVariables, derivedSessionVariables, booleanInputMap, computedVariables, inputVariableMap, userDeclarationCode, userDeclarationSymbolNames);
	return `/**
...
//# sourceMappingURL=src-FI_T73Iq.cjs.map