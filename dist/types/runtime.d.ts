...
export interface PineJSStdLibrary {
    ...
    alma: (series: PineSeries, length: number, offset: number, sigma: number, context: RuntimeContext) => number;
    linreg: (series: PineSeries, length: number, offset: number, context: RuntimeContext) => number;
    ...
    macd: (series: PineSeries, fast: number, slow: number, signal: number, context: RuntimeContext) => [number, number, number];
    stoch: (source: PineSeries, high: PineSeries, low: PineSeries, length: number, context: RuntimeContext) => number;
    ...
    tsi: (series: PineSeries, short: number, long: number, context: RuntimeContext) => number;
    atr: (length: number, context: RuntimeContext) => number;
    tr: (handleNaOrContext: boolean | RuntimeContext, context?: RuntimeContext) => number;
    stdev: (series: PineSeries, length: number, context: RuntimeContext) => number;
    variance: (series: PineSeries, length: number, context: RuntimeContext) => number;
    dev: (series: PineSeries, length: number, context: RuntimeContext) => number;
    bb: (series: PineSeries, length: number, mult: number, context: RuntimeContext) => [number, number, number];
    bbw: (series: PineSeries, length: number, mult: number, context: RuntimeContext) => number;
    kc: (series: PineSeries, length: number, mult: number, context: RuntimeContext) => [number, number, number];
    kcw: (series: PineSeries, length: number, mult: number, context: RuntimeContext) => number;
    donchian: (length: number, context: RuntimeContext) => [number, number, number];
    adx: (diLength: number, adxSmoothing: number, context: RuntimeContext) => number;
    dmi: (diLength: number, adxSmoothing: number, context: RuntimeContext) => [number, number, number, number, number];
    supertrend: (factor: number, atrPeriod: number, context: RuntimeContext) => [number, number];
    sar: (start: number, inc: number, max: number, context: RuntimeContext) => number;
    pivothigh: (series: PineSeries, leftbars: number, rightbars: number, context: RuntimeContext) => number;
    pivotlow: (series: PineSeries, leftbars: number, rightbars: number, context: RuntimeContext) => number;
    cross: (series1: PineSeries, series2: PineSeries, context: RuntimeContext) => boolean;
    crossover: (series1: PineSeries, series2: PineSeries, context: RuntimeContext) => boolean;
    crossunder: (series1: PineSeries, series2: PineSeries, context: RuntimeContext) => boolean;
    rising: (series: PineSeries, length: number, context: RuntimeContext) => boolean;
    falling: (series: PineSeries, length: number, context: RuntimeContext) => boolean;
    obv: (context: RuntimeContext) => number;
    vwap: (source: PineSeries, anchor: unknown, stdevMult: number | undefined, context: RuntimeContext) => number | [number, number, number];
    ...
    change: (series: PineSeries, length: number, context?: RuntimeContext) => number;
    percentrank: (series: PineSeries, length: number, context: RuntimeContext) => number;
    highest: (series: PineSeries, length: number, context: RuntimeContext) => number;
    lowest: (series: PineSeries, length: number, context: RuntimeContext) => number;
    highestbars: (series: PineSeries, length: number, context: RuntimeContext) => number;
    lowestbars: (series: PineSeries, length: number, context: RuntimeContext) => number;
    median: (series: PineSeries, length: number, context: RuntimeContext) => number;
    mode: (series: PineSeries, length: number, context: RuntimeContext) => number;
    correlation: (series1: PineSeries, series2: PineSeries, length: number, context: RuntimeContext) => number;
    cov: (series1: PineSeries, series2: PineSeries, length: number, context: RuntimeContext) => number;
    valuewhen: (condition: boolean, source: PineSeries, occurrence: number, context: RuntimeContext) => number;
...
export interface StudyInputInfo {
    ...
    name: string;
    /** Input type */
    type: 'integer' | 'float' | 'bool' | 'source' | 'text' | 'session' | 'time' | 'color';
    /** Default value */
